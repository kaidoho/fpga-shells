...
set_property -dict { PACKAGE_PIN N3   IOSTANDARD DIFF_SSTL135 } [get_ports { ddr3_dqs_n[1] }];
...
set_property -dict { PACKAGE_PIN T2   IOSTANDARD SSTL135 } [get_ports { ddr3_cke[2] }];
set_property -dict { PACKAGE_PIN P5   IOSTANDARD SSTL135 } [get_ports { ddr3_odt[1] }];
