...
package sifive.fpgashells.ip.xilinx.artyS750mig
...
// IP VLNV: xilinx.com:customize_ip:artyS750mig:1.0
// Black Box

class ARTYS750MIGIODDR(depth : BigInt) extends GenericParameterizedBundle(depth) {
...
//reused directly in io bundle for sifive.blocks.devices.xilinxartys7mig
trait ARTYS750MIGIOClocksReset extends Bundle {
  //inputs
...
class artyS750mig(depth : BigInt)(implicit val p:Parameters) extends BlackBox
{
  require((depth<=0x10000000L),"artyS750mig supports up to 256MB depth configuraton")
  override def desiredName = "artyS750mig" 

  val io = new ARTYS750MIGIODDR(depth) with ARTYS750MIGIOClocksReset {
    // User interface signals
    ...
    val s_axi_awaddr          = Bits(INPUT,28)
    ...
    val s_axi_araddr          = Bits(INPUT,28)
   ...
   val artyS7migprj = """ {<?xml version='1.0' encoding='UTF-8'?>
<!-- IMPORTANT: This is an internal file that has been generated by the MIG software. Any direct editing or changes made to this file may result in unpredictable behavior or data corruption. It is strongly advised that users do not edit the contents of this file. Re-run the MIG GUI with the required settings if any of the options provided below need to be altered. -->
<Project NoOfControllers="1" >
    <ModuleName>artyS7mig</ModuleName>
  ...
  val migprj = artyS7migprj
  val migprjname =  """{/artyS7mig.prj}"""
  val modulename =  """artyS7mig"""
